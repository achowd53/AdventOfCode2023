...
def createNetworkXGraphFromGrid(complex_grid, neighbors=fourNeighbors, coord_compression=False, ignore_compress=(lambda x: x not in []), undirected=True):
    edges = []
    ...
    return G
def createNetworkXGraphFromAdjacency(adjacency_dict, coord_compression=False, ignore_compress=(lambda x: x not in []), undirected=True):
    edges = []
